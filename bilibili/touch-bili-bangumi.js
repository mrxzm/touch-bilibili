...
class BiliBangumi extends Bili{
    init(){
        let videoContainer = ['#bilibili-player > div > div > div.bpx-player-primary-area > div.bpx-player-video-area > div.bpx-player-video-perch'];
        let bottomBtns = [
            'div.squirtle-video-quality > div.squirtle-select-header',
        ...
        super.execute(videoContainer, super.optimize);
    }
}
window["touch-bili-bangumi"] || (function () { window["touch-bili-bangumi"] = true; new BiliBangumi().init();})();